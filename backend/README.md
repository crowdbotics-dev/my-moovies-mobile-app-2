...
## Project Structure
    ...
    ├── my_moovies_mobile_app_2  # Django project configurations
...
1. Clone this repo and `cd my_moovies_mobile_app_2`
...
2. Clone this repo and `cd my_moovies_mobile_app_2`
