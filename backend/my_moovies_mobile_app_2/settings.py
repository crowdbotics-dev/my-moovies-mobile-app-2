"""
Django settings for my_moovies_mobile_app_2 project.
...
ROOT_URLCONF = 'my_moovies_mobile_app_2.urls'
...
WSGI_APPLICATION = 'my_moovies_mobile_app_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my_moovies_mobile_app_2 API",
    "DESCRIPTION": "API documentation for my_moovies_mobile_app_2 App",
    "VERSION": "v1",
}
